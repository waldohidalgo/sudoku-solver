...
module.exports = function (app) {
  app.route("/_api/server.js").get(function (req, res, next) {
    ...
    fs.readFile(path.resolve("server.js"), function (err, data) {
  ...
  app.route("/_api/routes/api.js").get(function (req, res, next) {
    console.log("requested");
    fs.readFile(path.resolve("routes", "api.js"), function (err, data) {
      if (err) return next(err);
  ...
  app
    ...
    .get(function (req, res, next) {
      console.log("requested");
      fs.readFile(
        path.resolve("controllers", "convertHandler.js"),
        function (err, data) {
          if (err) return next(err);
          res.type("txt").send(data.toString());
        }
